...
// Tests for draft public classes:
    { "fty_exdialogue_server", fty_exdialogue_server_test },
    { "fty_exdialogue_client", fty_exdialogue_client_test },
#endif // FTY_EXDIALOGUE_BUILD_DRAFT_API
#ifdef FTY_EXDIALOGUE_BUILD_DRAFT_API
    { "private_classes", fty_exdialogue_private_selftest },
#endif // FTY_EXDIALOGUE_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-l")) {
            ...
            puts ("    fty_exdialogue_server\t\t- draft");
            puts ("    fty_exdialogue_client\t\t- draft");
